...
- [x] Implement `DeductCredit(userID, teamID, instanceID string) error` 
  ...
  - [x] Return clear errors for insufficient credits (handled by team service)
...
- [x] Write unit tests for credit service
...
- [x] Add error handling for team start logging failures
- [x] Write unit tests for team start service
...
- [x] Add error handling for insufficient credits with clear user messages
- [x] Test with multiple concurrent team starts
- [x] Test transaction rollback on credit deduction failures
...
- [x] Add error handling and retry logic for failed monthly grants
...
- [x] Test with various team start histories

#### Admin Credit Management
- [x] Create admin page for credit management
- [x] Allow admins to add credits
- [x] Show user's current balance and team start history
- [x] Add reason field for credit adjustments
- [x] Test admin functionality with various scenarios

#### Pricing Page Update
- [x] Update `/internal/templates/public/pricing.templ` with credit-based pricing model
- [x] Update `/internal/handlers/public/pricing.go` to handle credit pricing display
- [x] Design friendly, transparent messaging about credit system
- [x] Add "Top Up Credits" call-to-action section for logged-in users
...
- [x] Team start history is complete and accessible
- [ ] Admins can successfully add credits to accounts
- [ ] Team start performance impact <50ms
- [ ] System handles 100+ concurrent users
- [ ] Database operations are atomic and consistent
- [x] Pricing page accurately communicates credit model with friendly, transparent messaging
