...
func checklistPlayer(settings models.InstanceSettings, block blocks.ChecklistBlock, data blocks.PlayerState) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, item := range block.List {
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"form-control\"><label class=\"label cursor-pointer flex gap-3 justify-start text-base-content\"><input id=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if data.IsComplete() {
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(" disabled class=\"checkbox checkbox-success\"")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			} else {
...
func checklistItem(item blocks.ChecklistItem) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<label class=\"w-full checklist-item input bg-transparent flex flex-row items-start gap-2 h-auto join-item\" data-item-id=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
