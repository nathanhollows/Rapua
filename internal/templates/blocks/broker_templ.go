...
func brokerTierAdmin(tierNum int, tier blocks.InformationTier) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</span> Points</legend> <input name=\"tier_points\" type=\"number\" class=\"input w-full invalid:border-error\" placeholder=\"1\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
