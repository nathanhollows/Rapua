...
func TemplatePeview(link models.ShareLink, authed bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if authed {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 31, "</code> template.</p><form hx-post=\"/admin/templates/launch-from-link\" hx-swap=\"none\"><fieldset class=\"fieldset\"><legend class=\"fieldset-legend\">Game name</legend> <input type=\"text\" class=\"input w-full\" name=\"name\" required autocomplete=\"off\" value=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			var templ_7745c5c3_Var15 string
			templ_7745c5c3_Var15, templ_7745c5c3_Err = templ.JoinStringErrs(link.Template.Name)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/public/templates.templ`, Line: 298, Col: 33}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var15))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 32, "\"><p class=\"label\">You can edit this later on.</p><input type=\"hidden\" name=\"link\" value=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			var templ_7745c5c3_Var16 string
			templ_7745c5c3_Var16, templ_7745c5c3_Err = templ.JoinStringErrs(link.ID)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/public/templates.templ`, Line: 301, Col: 54}
			}
...
func renderGroupedLocations(group *models.GameStructure, allLocations []models.Location, depth int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if !group.IsRoot && group.Name != "" {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 36, "<option disabled>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if !hasFirstSubGroupNamed(group, "Locations") {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 39, "<option disabled>Locations</option>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
		...
		for _, locationID := range group.LocationIDs {
			for _, location := range allLocations {
				if location.ID == locationID {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 40, "<option hx-trigger=\"chosen\" hx-get=\"")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					var templ_7745c5c3_Var20 string
					templ_7745c5c3_Var20, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprint("/checkins/", location.MarkerID))
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/public/templates.templ`, Line: 547, Col: 57}
					}
					...
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 42, "\" class=\"location-option\" _=\"\n\t\t\t\t\ton change from #pages\n\t\t\t\t\t\tif #pages.options[#pages.selectedIndex].value == me.value then\n\t\t\t\t\t\t\tsend chosen to me\n\t\t\t\t\t\t\tcall window.history.replaceState(null, '', '#' + me.value)\n\t\t\t\t\t\tend\n\t\t\t\t\tend\n\t\t\t\t\ton load\n\t\t\t\t\t\tif window.location.hash == '#' + me.value then\n\t\t\t\t\t\t\tsend chosen to me\n\t\t\t\t\t\t\tset #pages's value to my.value\n\t\t\t\t\t\tend\n\t\t\t\t\tend\n\t\t\t\t\t\"")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					if location.Marker.IsMapped() {
						templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 43, " data-lat=\"")
						if templ_7745c5c3_Err != nil {
							return templ_7745c5c3_Err
						}
