...
func TemplatePeview(link models.ShareLink, authed bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "\"> <select id=\"pages\" class=\"select select-sm w-56 md:w-96 mx-auto text-ellipsis\" _=\"\n\t\t\t\t\t\t\t\t\t\ton load\n\t\t\t\t\t\t\t\t\t\tset :hash to window.location.hash\n\t\t\t\t\t\t\t\t\t\tif :hash == '' then\n\t\t\t\t\t\t\t\t\t\t\ttrigger change on me\n\t\t\t\t\t\t\t\t\t\tend\n\t\t\t\t\t\t\t\t\t\" name=\"page\"><option disabled class=\"font-bold\">Pages</option> <option hx-trigger=\"chosen\" hx-get=\"/start\" selected value=\"start\" _=\"\n\t\t\t\t\t\t\t\t\t\t\ton change from #pages\n\t\t\t\t\t\t\t\t\t\t\t\tif #pages.options[#pages.selectedIndex].value == me.value then\n\t\t\t\t\t\t\t\t\t\t\t\t\tsend chosen to me\t\n\t\t\t\t\t\t\t\t\t\t\t\t\tcall window.history.replaceState(null, '', '#' + me.value)\n\t\t\t\t\t\t\t\t\t\t\t\tend\n\t\t\t\t\t\t\t\t\t\t\tend\n\t\t\t\t\t\t\t\t\t\t\ton load\n\t\t\t\t\t\t\t\t\t\t\t\tif window.location.hash == '#start' then\n\t\t\t\t\t\t\t\t\t\t\t\t\tsend chosen to me\n\t\t\t\t\t\t\t\t\t\t\t\t\tset #pages's value to my.value\n\t\t\t\t\t\t\t\t\t\t\t\tend\n\t\t\t\t\t\t\t\t\t\t\tend\n\t\t\t\t\t\t\t\t\t\t\t\">Start</option> <option hx-trigger=\"chosen\" hx-get=\"/next\" value=\"next\" _=\"\n\t\t\t\t\t\t\t\t\t\t\ton change from #pages\n\t\t\t\t\t\t\t\t\t\t\t\tif #pages.options[#pages.selectedIndex].value == me.value then\n\t\t\t\t\t\t\t\t\t\t\t\t\tsend chosen to me\t\n\t\t\t\t\t\t\t\t\t\t\t\t\tcall window.history.replaceState(null, '', '#' + me.value)\n\t\t\t\t\t\t\t\t\t\t\t\tend\n\t\t\t\t\t\t\t\t\t\t\tend\n\t\t\t\t\t\t\t\t\t\t\ton load\n\t\t\t\t\t\t\t\t\t\t\t\tif window.location.hash == '#next' then\n\t\t\t\t\t\t\t\t\t\t\t\t\tsend chosen to me\n\t\t\t\t\t\t\t\t\t\t\t\t\tset #pages's value to my.value\n\t\t\t\t\t\t\t\t\t\t\t\tend\n\t\t\t\t\t\t\t\t\t\t\tend\n\t\t\t\t\t\t\t\t\t\t\t\">Navigation</option>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = renderGroupedLocations(&link.Template.GameStructure, link.Template.Locations, 0).Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "</select></form><button id=\"forward\" class=\"btn btn-sm btn-circle btn-ghost\" _=\"\n\t\t\t\t\t\t\t\ton change from <select /> or load\n\t\t\t\t\t\t\t\t\tset sel to #pages \n\t\t\t\t\t\t\t\t\tif sel.selectedIndex == sel.length - 1 then add .btn-disabled to me\n\t\t\t\t\t\t\t\t\telse remove .btn-disabled from me\n\t\t\t\t\t\t\t\tend\n\t\t\t\t\t\t\t\ton click \n\t\t\t\t\t\t\t\t\t  set sel to #pages \n\t\t\t\t\t\t\t\t\t  set i to sel.selectedIndex + 1\n\t\t\t\t\t\t\t\t\t  repeat while i < sel.length and sel.options[i].disabled \n\t\t\t\t\t\t\t\t\t\tincrement i\n\t\t\t\t\t\t\t\t\t  end\n\t\t\t\t\t\t\t\t\t  if i < sel.length then set sel.selectedIndex to i\n\t\t\t\t\t\t\t\t\t  trigger change on sel\n\t\t\t\t\t\t\t\t  \"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" class=\"lucide lucide-arrow-right-icon lucide-arrow-right\"><path d=\"M5 12h14\"></path><path d=\"m12 5 7 7-7 7\"></path></svg></button></div></div><div class=\" border-t border-base-300 overflow-scroll\"><div id=\"preview\" class=\"overflow-scroll py-12 px-4\" hx-vals=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		var templ_7745c5c3_Var5 string
		templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprint(`{"instanceID": "`, link.TemplateID, `"}`))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/public/templates.templ`, Line: 148, Col: 70}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var5))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "\"><span class=\"loading loading-spinner loading-lg\"></span></div></div></div></section></main><aside id=\"sidebar\" class=\"flex flex-col gap-5 md:w-96 h-min\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if authed {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "<a class=\"btn btn-primary btn-lg group tooltip inline-flex items-center\" onclick=\"launch_template_modal.showModal()\" data-tip=\"Create a new game using this template.\">Launch <svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" class=\"lucide lucide-rocket w-4 h-4 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform\"><path d=\"M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z\"></path><path d=\"m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z\"></path><path d=\"M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0\"></path><path d=\"M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5\"></path></svg></a>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		} else {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "<a class=\"btn btn-lg group tooltip inline-flex items-center\" href=\"/login\" data-tip=\"Log in to create a new game using this template.\">Log in to launch <svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" class=\"lucide lucide-rocket w-4 h-4 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform\"><path d=\"M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z\"></path><path d=\"m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z\"></path><path d=\"M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0\"></path><path d=\"M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5\"></path></svg></a>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "<div class=\"card bg-base-200 card-md shadow-sm\"><div class=\"card-body\"><h2 class=\"card-title\">Template Details</h2><div class=\"prose\"><ul><li>Created ")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if !link.ExpiresAt.IsZero() {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "<span class=\"tooltip cursor-help underline decoration-dashed\" data-tip=\"This link is temporary and will expire.\">Expires ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "<span class=\"tooltip cursor-help underline decoration-dashed\" data-tip=\"This link will never expire.\">Never expires</span>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		...
		if link.MaxUses == 0 {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "<span class=\"tooltip cursor-help underline decoration-dashed\" data-tip=\"This template may be launched an unlimited number of times.\">Unlimited launches</span>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		} else {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 16, "<span class=\"tooltip cursor-help underline decoration-dashed\" data-tip=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			var templ_7745c5c3_Var8 string
			templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%d/%d launches left.", link.UsedCount, link.MaxUses))
			if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 19, "</li><li><span class=\"tooltip cursor-help underline decoration-dashed\" data-tip=\"Only those with the link can access this template.\">Private link</span></li></ul></div></div></div><div class=\"card bg-base-200 card-md shadow-sm\"><div class=\"card-body\"><h2 class=\"card-title\">Game Settings</h2><div class=\"prose\"><ul><li><strong>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 20, "</strong> locations</li><li><strong>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if len(link.Template.GameStructure.SubGroups) == 1 {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 22, "group")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		} else {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 23, "groups")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		...
		if link.Template.Settings.EnablePoints {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 25, "<li>Points are <strong>enabled</strong></li>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if link.Template.Settings.EnableBonusPoints {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 26, "<li>Bonus points are <strong>enabled</strong></li>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			} else {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 27, "<li>Bonus points are <strong>disabled</strong></li>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
		} else {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 28, "<li>Points are <strong>disabled</strong></li>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 29, "</ul></div></div></div></aside></div><div class=\"max-w-7xl m-auto px-8 w-full\"><div id=\"map-container\" class=\"relative w-full rounded-lg shadow-lg my-5 h-96\"><div id=\"map-activity\" class=\"map w-full h-full rounded-lg\"></div></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if authed {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 30, "<!-- Launch template modal --> <dialog id=\"launch_template_modal\" class=\"modal modal-bottom sm:modal-middle\"><div class=\"modal-box prose overflow-y-visible\"><h3 class=\"text-lg font-bold\">Launch a new game</h3><p class=\"text-wrap\">You are about to launch a new game from the <code id=\"launch-template-name\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/public/templates.templ`, Line: 294, Col: 54}
			}
...
// renderGroupedLocations recursively renders locations grouped by the game structure hierarchy
func renderGroupedLocations(group *models.GameStructure, allLocations []models.Location, depth int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		templ_7745c5c3_W, ctx := templ_7745c5c3_Input.Writer, templ_7745c5c3_Input.Context
		if templ_7745c5c3_CtxErr := ctx.Err(); templ_7745c5c3_CtxErr != nil {
			return templ_7745c5c3_CtxErr
		...
		ctx = templ.ClearChildren(ctx)
		if !group.IsRoot && group.Name != "" {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 35, "<option disabled>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/public/templates.templ`, Line: 527, Col: 31}
			}
			...
			if !hasFirstSubGroupNamed(group, "Locations") {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 38, "<option disabled>Locations</option>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
		...
		for _, locationID := range group.LocationIDs {
			for _, location := range allLocations {
				if location.ID == locationID {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 39, "<option hx-trigger=\"chosen\" hx-get=\"")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					var templ_7745c5c3_Var19 string
					templ_7745c5c3_Var19, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprint("/checkins/", location.MarkerID))
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/public/templates.templ`, Line: 540, Col: 57}
					}
					...
					templ_7745c5c3_Var20, templ_7745c5c3_Err = templ.JoinStringErrs(location.MarkerID)
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/public/templates.templ`, Line: 541, Col: 30}
					}
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var20))
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 41, "\" class=\"location-option\" _=\"\n\t\t\t\t\ton change from #pages\n\t\t\t\t\t\tif #pages.options[#pages.selectedIndex].value == me.value then\n\t\t\t\t\t\t\tsend chosen to me\n\t\t\t\t\t\t\tcall window.history.replaceState(null, '', '#' + me.value)\n\t\t\t\t\t\tend\n\t\t\t\t\tend\n\t\t\t\t\ton load\n\t\t\t\t\t\tif window.location.hash == '#' + me.value then\n\t\t\t\t\t\t\tsend chosen to me\n\t\t\t\t\t\t\tset #pages's value to my.value\n\t\t\t\t\t\tend\n\t\t\t\t\tend\n\t\t\t\t\t\"")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					if location.Marker.IsMapped() {
						templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 42, " data-lat=\"")
						if templ_7745c5c3_Err != nil {
							return templ_7745c5c3_Err
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/public/templates.templ`, Line: 558, Col: 48}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/public/templates.templ`, Line: 559, Col: 48}
						}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/public/templates.templ`, Line: 561, Col: 20}
					}
		...
		for i := range group.SubGroups {
			templ_7745c5c3_Err = renderGroupedLocations(&group.SubGroups[i], allLocations, depth+1).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
...
// hasFirstSubGroupNamed checks if the first subgroup has the given name
func hasFirstSubGroupNamed(group *models.GameStructure, name string) bool {
	if len(group.SubGroups) > 0 && group.SubGroups[0].Name == name {
		return true
	}
	return false
}
