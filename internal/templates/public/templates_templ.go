...
func TemplatePeview(link models.ShareLink, authed bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\"><span class=\"loading loading-spinner loading-lg\"></span></div></div></div></section></main><aside id=\"sidebar\" class=\"flex flex-col gap-5 md:w-96 h-min\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if authed {
		...
		if authed {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</code> template.</p><form hx-post=\"/admin/templates/launch-from-link\" hx-swap=\"none\"><label class=\"form-control w-full\"><div class=\"label\"><span class=\"label-text\">What is the name of the new game?</span></div><input type=\"text\" class=\"input w-full\" name=\"name\" required autocomplete=\"off\"> <input type=\"hidden\" name=\"link\" value=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
