...
func TemplatePeview(link models.ShareLink, authed bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 27, "</ul></div></div></div></aside></div><div class=\"max-w-7xl m-auto px-8 w-full\"><div id=\"map-container\" class=\"relative w-full rounded-lg shadow-lg my-5 h-96\"><div id=\"map-activity\" class=\"map w-full h-full rounded-lg\"></div></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if authed {
...
func renderGroupedLocations(group *models.GameStructure, allLocations []models.Location, depth int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if !group.IsRoot && group.Name != "" {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 34, "<option disabled>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if !hasFirstSubGroupNamed(group, "Locations") {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 37, "<option disabled>Locations</option>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
		...
		for _, locationID := range group.LocationIDs {
			for _, location := range allLocations {
				if location.ID == locationID {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 38, "<option hx-trigger=\"chosen\" hx-get=\"")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					...
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 40, "\" class=\"location-option\" _=\"\n\t\t\t\t\ton change from #pages\n\t\t\t\t\t\tif #pages.options[#pages.selectedIndex].value == me.value then\n\t\t\t\t\t\t\tsend chosen to me\n\t\t\t\t\t\t\tcall window.history.replaceState(null, '', '#' + me.value)\n\t\t\t\t\t\tend\n\t\t\t\t\tend\n\t\t\t\t\ton load\n\t\t\t\t\t\tif window.location.hash == '#' + me.value then\n\t\t\t\t\t\t\tsend chosen to me\n\t\t\t\t\t\t\tset #pages's value to my.value\n\t\t\t\t\t\tend\n\t\t\t\t\tend\n\t\t\t\t\t\"")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
