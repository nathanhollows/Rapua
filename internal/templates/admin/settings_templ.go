...
func SettingsProfile(user models.User) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.ResolveAttributeValue(user.Name)
		if templ_7745c5c3_Err != nil {
		...
		if user.DisplayName.Valid {
			...
			templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.ResolveAttributeValue(user.DisplayName.String)
			if templ_7745c5c3_Err != nil {
		...
		if user.WorkType.Valid && user.WorkType.String != "formal_education" && user.WorkType.String != "informal_education" && user.WorkType.String != "event_organiser" && user.WorkType.String != "experience_designer" && user.WorkType.String != "corporate_training" {
			...
			templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.ResolveAttributeValue(user.WorkType.String)
			if templ_7745c5c3_Err != nil {
...
func SettingsAppearance(user models.User) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, theme := range themes() {
			...
			templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.ResolveAttributeValue(strings.ToLower(theme))
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.ResolveAttributeValue(strings.ToLower(theme))
			if templ_7745c5c3_Err != nil {
