...
func nav(user models.User, section string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if user.CurrentInstance.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/admin/layouts.templ`, Line: 233, Col: 34}
			}
		...
		if len(user.Instances) > 0 {
			...
			for _, instance := range user.Instances {
				...
				if instance.ID == user.CurrentInstance.ID {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/admin/layouts.templ`, Line: 258, Col: 28}
					}
